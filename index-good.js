...
var gp = require(process.env.MTS_GLOBALS).gp;
var id = require(process.env.MTS_ELEMENTS).id;
var featuresDir = process.env.MTS_LIBRARIES;

var testScript = process.env.MTS_SCRIPT;
var scriptName = testScript.substr(testScript.lastIndexOf('/'));

var scriptContents = openScriptFile(testScript);
var commands = parseScript(scriptContents);
...
describe("Test Engine", function() {
    ...
    describe("Run Script Test: " + scriptName, function() {
        it("Execute Script Test: " + testScript, function() {
            return executeScript(scriptContents);
        });
